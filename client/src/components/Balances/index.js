    ...
    <Box p={2} minWidth="350px">
      <Card flexDirection="column">
        <Box>
          ...
          <ChipBalance accountName="Player" accountAddress={player} {...props} />
          <ChipBalance accountName="Owner" accountAddress={owner} {...props} />
          <ChipBalance accountName="Bankroll" accountAddress={bankroll} {...props} />
        </Box>
        <Box mt={4}>
...
const ChipBalance = ({ accountName, accountAddress, drizzle, drizzleState }) => (
...
const ChipAllowance = ({ accountAddress, spenderName, spenderAddress, drizzle, drizzleState }) => (
  <Flex pt={2} justifyContent="space-between" alignItems="center">
    <Box><Heading.h5>{spenderName}{": "}</Heading.h5></Box>
    <Text>
      <ContractData
        drizzle={drizzle}
        drizzleState={drizzleState}
