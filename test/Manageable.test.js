...
contract('Manageable', function ([_, owner, manager, otherManager, anyone, ...otherAccounts]) {
                ...
                context('when unpaused', function () {
                    ...
                    describe('pausing', function () {
                        ...
                        context('when paused', function () {
                            beforeEach(async function () {
                                ({ logs: this.logs } = await this.manageable.pause({ from: manager }));
                            });
                            ...
                            it('can take a drastic measure in a pause', async function () {
                                ...
                                (await this.manageable.drasticMeasureTaken()).should.equal(true);
                            });
                            ...
                            describe('unpausing', function () {
                                ...
                                context('when unpaused', function () {
                                    beforeEach(async function () {
                                        ({ logs: this.logs } = await this.manageable.unpause({ from: manager }));
                                    });

                                    it('emits an Unpaused event', function () {
                                        expectEvent.inLogs(this.logs, 'Unpaused', { account: manager });
                                    });
